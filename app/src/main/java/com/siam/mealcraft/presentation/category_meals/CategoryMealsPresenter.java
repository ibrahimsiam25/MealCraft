...
public class CategoryMealsPresenter implements ICategoryMealsPresenter {
    ...
    public void toggleFavourite(FilteredMeal meal) {
        // Implementation for toggle fovourite.
        // Assuming Repo has toggle logic methods based on instructions:
        // You'd check if favorite, then insert+add or remove from db.
        // For brevity, let's leave as a placeholder for the Toggle Logic.
        disposable.add(
